    ...
    <form>
        <div class="columns">
            <div class="tops column is-offset-4">
                ...
                <input type="text" class="input is-primary column is-5" placeholder="Username or Email"><br>

                <label for="" class="is-size-3 has-text-white">Password</label>
                <input type="text" class="input is-primary column is-5" placeholder="Password "><br>
